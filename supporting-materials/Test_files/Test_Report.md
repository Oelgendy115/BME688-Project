...
- **Hardware:**
  ...
  - An SD card containing the configuration file for heater profiles was used to dynamically load sensor settings, with heater_354 located in the config folder inside the C++ code directory.
